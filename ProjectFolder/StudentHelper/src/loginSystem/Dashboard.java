...
public class Dashboard extends JPanel{
	...
	JLabel lblGrade,lblSchool,lblGpa;
	...
	public JLabel getLblSchool() {
		return lblSchool;
	}

	public void setLblSchool(JLabel lblSchool) {
		this.lblSchool = lblSchool;
	}

	public JLabel getLblGpa() {
		return lblGpa;
	}

	public void setLblGpa(JLabel lblGpa) {
		this.lblGpa = lblGpa;
	}
...
/*	private static int hours = 0;
	...
	private void initialize() {
		...
		/*setEditorPane(new JEditorPane());
		getEditorPane().setBackground(new Color(240, 255, 255));
		getEditorPane().setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		getEditorPane().setBounds(16, 52, 182, 318);
		panel_16.add(getEditorPane());*/
	...
	public static void setEditorPane(JEditorPane editorPane) {
		Dashboard.editorPane = editorPane;
	}*/
}
