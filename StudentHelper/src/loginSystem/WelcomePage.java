...
public class WelcomePage {
	...
	private void initialize() {
		...
		textField.setBounds(763, 17, 130, 26);
		panel.add(textField);
		textField.setColumns(10);
		
		JLabel lblNewLabel_5 = new JLabel("");
		lblNewLabel_5.setIcon(new ImageIcon(WelcomePage.class.getResource("/Resource/ps_search.jpg")));
		lblNewLabel_5.setBounds(889, 17, 40, 26);
		...
		/*JLabel lblNewLabel_4 = new JLabel("Sample text");
		lblNewLabel_4.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		lblNewLabel_4.setForeground(new Color(0, 0, 255));
		lblNewLabel_4.setBounds(684, 101, 256, 26);
